...
public class ToChattogram extends JFrame implements ActionListener
{
    ...
    public ToChattogram()
    {
        this.setTitle("BTMS - Choose seat(Dhaka to Chattogram)");
    ...
    public void Initialize()
    {
        ...
        File file = new File("D://Java//DhakaToChattogram.txt");
        ...
        if(!file.exists())
        {
            ...
            {
                file.createNewFile();
                FileWriter writer = new FileWriter("D://Java//DhakaToChattogram.txt", false);
                for (int start = 0; start < 48; start++)
                {
        ...
        else
        {
            try
            {
                BufferedReader br = new BufferedReader(new FileReader("D://Java//DhakaToChattogram.txt"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (e.getSource() == purchase)
        {
            try
            {
                ...
                this.setVisible(false);
                ToChattogram d = new ToChattogram();
                d.setVisible(true);
            } 
            catch (Exception ex)
            {
