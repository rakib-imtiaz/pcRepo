...
public class ToKhulna extends JFrame implements ActionListener
{
    ...
    public ToKhulna()
    {
        this.setTitle("BTMS - Choose seat(Dhaka to Khulna)");
    ...
    public void Initialize()
    {
        ...
        File file = new File("D://Java//DhakaToKhulna.txt");
        ...
        if(!file.exists())
        {
            ...
            {
                file.createNewFile();
                FileWriter writer = new FileWriter("D://Java//DhakaToKhulna.txt", false);
                for (int start = 0; start < 48; start++)
                {
        ...
        else
        {
            try
            {
                BufferedReader br = new BufferedReader(new FileReader("D://Java//DhakaToKhulna.txt"));
