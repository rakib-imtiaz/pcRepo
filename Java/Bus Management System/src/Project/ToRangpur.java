...
public class ToRangpur extends JFrame implements ActionListener
{
    ...
    public ToRangpur()
    {
        this.setTitle("BTMS - Choose seat(Dhaka to Rangpur)");
    ...
    public void Initialize()
    {
        ...
        File file = new File("D://Java//DhakaToRangpur.txt");
        ...
        if(!file.exists())
        {
            ...
            {
                file.createNewFile();
                FileWriter writer = new FileWriter("D://Java//DhakaToRangpur.txt", false);
                for (int start = 0; start < 48; start++)
                {
        ...
        else
        {
            try
            {
                BufferedReader br = new BufferedReader(new FileReader("D://Java//DhakaToRangpur.txt"));
