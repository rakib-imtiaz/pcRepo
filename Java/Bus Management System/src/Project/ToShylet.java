...
public class ToShylet extends JFrame implements ActionListener
{
    ...
    public ToShylet()
    {
        this.setTitle("BTMS - Choose seat(Dhaka to Shylet)");
        this.setBounds(300, 80, 870, 850);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setResizable(false);
        this.setIconImage(Toolkit.getDefaultToolkit().getImage("F://Java//bus.png"));
    ...
    public void Initialize()
    {
        ...
        File file = new File("D://Java//DhakaToShylet.txt");
        ...
        if(!file.exists())
        {
            ...
            {
                file.createNewFile();
                FileWriter writer = new FileWriter("D://Java//DhakaToShylet.txt", false);
                for (int start = 0; start < 48; start++)
                {
        ...
        else
        {
            try
            {
                BufferedReader br = new BufferedReader(new FileReader("D://Java//DhakaToShylet.txt"));
