...
/*
 * 
 * I represened cases by this class
 * 
 * a class can contain the below things 
 * 
 * 
 * 
 * 
...
public class Case {
	...
	/**
	 *public constructor for creating cases
	 * 
	 * 
	 **/
	

	public Case(String title, String briefDescription, String shortSummary, String finalCulprit,
			boolean isCaseStatusActive, boolean isFinalCulpritFound, ArrayList<String> suspectList,
			ArrayList<String> evidencetList, Case obj, Scanner scan) {
		super();
		this.title = title;
	...
	/**
	 to string method for printing obejcts * 
	 * 
	 **/
