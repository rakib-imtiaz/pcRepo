...
public class ProductsEditor {
	...
	public ProductsEditor() throws IOException {
		goodsManagement();
	...
	public void addGoods() throws IOException {
		...
		while (true) {
			...
			Product product = new Product(goods_id, Good_name, Quantity, price_per_unit);
	...
	public void fetchDataFromFile(String filename) throws IOException {
		...
		while ((data = reader.readLine()) != null) {
			...
			Product customer = new Product(data_array[0], data_array[1], Double.parseDouble(data_array[2]),
